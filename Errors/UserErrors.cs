...
public record UserErrors
{
    ...
    public static readonly Error InvalidExternalToken =
        new("User.InvalidExternalToken", "Invalid external authentication token", StatusCodes.Status401Unauthorized);
    ...
    public static readonly Error UpgradeAlreadyRequested =
        new("User.UpgradeAlreadyRequested", "An upgrade request is already pending", StatusCodes.Status409Conflict);

    public static readonly Error NoUpgradeRequested =
        new("User.NoUpgradeRequested", "User has no pending upgrade request", StatusCodes.Status400BadRequest);
}
