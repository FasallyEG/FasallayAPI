...
namespace Fasally.Migrations
{
    ...
    [Migration("20260604084123_RenameCategoryTables")]
    partial class RenameCategoryTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fasally.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Fasally.Entities.OrderAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Fasally.Entities.OrderFabric", b =>
                {
                    b.Property<Guid>("OrderId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("OrderId", "FabricId");

                    b.HasIndex("FabricId");

                    b.ToTable("OrderFabrics");
                });

            modelBuilder.Entity("Fasally.Entities.OrderMeasurement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Fasally.Entities.Order", b =>
                {
                    b.HasOne("Fasally.Entities.Address", "Address")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Fasally.Entities.OrderAttachment", b =>
                {
                    b.HasOne("Fasally.Entities.Order", "Order")
            ...
            modelBuilder.Entity("Fasally.Entities.OrderFabric", b =>
                {
                    b.HasOne("Fasally.Entities.Product", "Fabric")
                        .WithMany("OrderFabrics")
            ...
            modelBuilder.Entity("Fasally.Entities.OrderMeasurement", b =>
                {
                    b.HasOne("Fasally.Entities.Order", "Order")
                        .WithOne("Measurement")
                        .HasForeignKey("Fasally.Entities.OrderMeasurement", "OrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
